...
public class MainScript : MonoBehaviour {
	...
	//14:32, SI APARECE SOLO "ITEM" ES PORQUE HAY QUE CARGAR (PUT) INFO PRIMERO
	// SI MODCIFICAMOS LOS .JSON Y DESPUES USAMOS PUT - PARA QUE VUELVA A FUNCIONAR DEBEMOS COLOCAR OTRA VEZ .JSON Y EMPEZAR OTRA VEZ LA BASE DE DATOS (ELIMINAR LA INFO QUE HABIA ANTES)
	
	private readonly string basePath = "https://jsonplaceholder.typicode.com"; // CAMBIAR POT URL
	...
	public void Get(){
		...
		//RestClient.DefaultRequestHeaders["Authorization"] = "Bearer ..."; NO NECESITA UN TOKEN DE AUTORIZACION

		RequestHelper requestOptions = null;

		//AGREGAR .json DESPUES DE POSTS
